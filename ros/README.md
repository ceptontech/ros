...
> which can be set to reduce the message size. This may help to improve performance.
> See the command below, and examine the #ifdef(WITH_POLAR) and #ifdef(WITH_TS_CH_F) in the code.

```bash
# This is recommended for Vista Ultra, unless the fields are needed.
