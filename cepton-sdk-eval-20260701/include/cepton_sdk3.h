...
#define CEPTON_SDK_CONTROL_FLAG_RETURN_SECOND (0x2 << 1)
#define CEPTON_SDK_CONTROL_FLAG_RETURN_BOTH (0x3 << 1)
  ...
  enum
  {
    ...
    // Emit only the selected parity frame, and drop the other.
    // This halves the frame rate and the downstream calibration load.
    CEPTON_AGGREGATION_MODE_SINGLE_PARITY_LEFT = -1, // Left -> Right scan
    CEPTON_AGGREGATION_MODE_SINGLE_PARITY_RIGHT = -2, // Right -> Left scan
  };
